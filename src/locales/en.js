  ...
  translation: {
    common: {
      ...
      deliceMenu: {
        ...
        appetizer: {
          title: 'Appetizer',
          option1: { name: 'Soup of the day' },
          option2: { name: 'Homemade cheese croquettes' },
          option3: { name: 'Homemade shrimp croquettes' }
        },
        mainCourse: {
          title: 'Main Course',
          option1: { name: 'Chicken in cream sauce with vegetables' },
          option2: { name: 'Flemish rabbit with salad and croquettes' },
          option3: { name: 'Baked salmon with bearnaise sauce' }
        },
        dessert: {
          title: 'Dessert',
          option1: { name: 'Chocolate mousse' },
